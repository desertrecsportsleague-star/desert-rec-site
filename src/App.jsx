...
const [schedule, setSchedule] = useState([]);const [playerStats, setPlayerStats] = useState([]);
...
throw new Error("Enter team name.");
}

if (!teamForm.captainName.trim()) {
throw new Error("Enter captain name.");
}

if (!teamForm.captainEmail.trim()) {
throw new Error("Enter captain email.");
}
...
body: JSON.stringify({
playerName: teamForm.captainName.trim(),
playerEmail: teamForm.captainEmail.trim(),
...
if (!waiverSignature.trim()) throw new Error("Type your full legal name.");if (!waiverAgree) throw new Error("You must agree to the waiver before paying.");
