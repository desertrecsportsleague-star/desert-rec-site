...
createRoot(document.getElementById('root')).render(<StrictMode>{isRoster?<TournamentRoster/>:isTournament?<TournamentPublic/>:isFallSchedule?<FallSoftballSchedule/>:isFallCaptain?<FallCaptainRoster/>:isFallSoftball?<FallSoftballRegistration/>:<App/>}{!special&&<JarvisAdminTools/>}{!special&&<JarvisHomepageSync/>}{!special&&<JarvisRegistrationSync/>}</StrictMode>)
