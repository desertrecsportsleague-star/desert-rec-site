...
function App() {
  ...
  async function loadData() {
    ...
    const [{ data: teamRows, error: teamError }, { data: freeAgentRows, error: freeError }, { data: scheduleRows, error: scheduleError }] =
      await Promise.all([
    ...
    if (freeError) console.error(freeError);
  ...
  async function updateFreeAgent(playerId, updates) {
    ...
    if (updates.assignedTeamId !== undefined) {
      payload.assigned_team_id = updates.assignedTeamId || null;
    }
    ...
    if (error) {
      console.error(error);
      alert("Unable to update free agent.");
      return;
    }
  ...
  async function deleteFreeAgent(playerId) {
    ...
    if (error) {
      console.error(error);
      alert("Unable to delete free agent.");
      return;
    }
  ...
  async function buildSchedule() {
    ...
    if (deleteError) {
      ...
      alert("Unable to clear old schedule.");
      return;
    }
  ...
  async function clearSchedule() {
    ...
    if (error) {
      console.error(error);
      alert("Unable to clear schedule.");
      return;
    }
        ...
        <section className="section">
          <div className="container">
            <div className="stats-grid">
              ...
              <div className="card">
                <div className="stat-label">Current Team Price</div>
                <div className="stat-value">${activePricing.price}</div>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="leagues-grid">
              <div className="card">
                ...
                <div className="league-note">
                  Current team price is {activePricing.label} at ${activePricing.price}.
                </div>
              </div>
      ...
      <section className="section">
        <div className="container">
          <div style={{ maxWidth: "760px", marginBottom: "28px" }}>
            ...
            <p className="section-copy">
              This admin dashboard now loads from Supabase so your registrations,
              assignments, and schedule are available across devices.
            </p>
          </div>
    ...
    <div className="site">
      <style>{`
        * { box-sizing: border-box; }
        ...
        .stats-grid, .leagues-grid, .roster-grid, .rules-grid, .rules-highlights {
          display: grid;
          gap: 20px;
        }
        ...
        @media (max-width: 980px) {
          .hero-inner, .waitlist-grid, .stats-grid, .leagues-grid, .roster-grid, .rules-grid, .rules-highlights {
