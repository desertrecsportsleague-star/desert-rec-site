...
console.error("SAVE TEAM BUTTON ERROR:", err);
...
console.error("FREE AGENT SAVE ERROR:", err);
alert(err.message || String(err));
} finally {
...
individually and be placed based on team needs.
</p>
<div className="row">
<button className="primary" onClick={() => setPage("register")}>
Go to Registration
...
<p className="section-subtitle">
Secure your team spot for the Thursday night coed league at Sundance Park.
</p>
...
<div className="row">
<button type="submit" className="primary" disabled={savingTeam}>
{savingTeam ? "Saving..." : "Save Team Registration"}
</button>
<button type="button" className="primary" disabled={startingCheckout} onClick={handleTeamCheckout}>
...
<button type="submit" className="primary" disabled={savingFreeAgent}>
...
<p className="section-subtitle">
Official playing rules for the Thursday night coed league.
</p>
<div className="grid2">
...
<div className="card">
<h3>Free Agents</h3>
<div>{freeAgents.length} free agents registered</div>
</div>
</>
)}
</div>
