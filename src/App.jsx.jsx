...
export default function App() {
  ...
  useEffect(() => {
    async function initAuth() {
      ...
      if (error) console.error("INIT AUTH ERROR:", error);
        ...
        <div className="container">
          <div className="waiver-page-card">
            ...
            <p className="section-copy" style={{ maxWidth: "100%" }}>
              This is the full waiver referenced during team registration and free agent sign-up. Team captains and coaches are subject to the standard waiver plus the added captain responsibility provisions.
            </p>
    ...
    <div className="site">
      <style>{`
        * { box-sizing: border-box; }
        ...
        .stats-grid, .rules-grid, .rules-highlights, .waitlist-grid {
          display: grid;
          gap: 20px;
        }
        ...
        @media (max-width: 980px) {
          .hero-inner, .waitlist-grid, .stats-grid, .rules-grid, .rules-highlights {
