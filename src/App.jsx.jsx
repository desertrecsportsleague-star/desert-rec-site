...
const response = await fetch("/api/create-team-checkout", {
method: "POST",
...
const { error } = await supabase.from("schedule_games").insert(rows);
if (error) throw new Error(error.message || JSON.stringify(error));
}
...
<p>Thursday night coed softball at Sundance Park.</p>
<p>
...
<label>
<input type="checkbox" checked={teamForm.agreeWaiver} onChange={(e) => setTeamForm((p) => ({ ...p, agreeWaiver: e.target.checked }))} /> I agree to the waiver
</label>
<label>
<input type="checkbox" checked={teamForm.agreeCaptainDuty} onChange={(e) => setTeamForm((p) => ({ ...p, agreeCaptainDuty: e.target.checked }))} /> I accept captain responsibility
</label>
<label>
<input type="checkbox" checked={teamForm.agreeElectronic} onChange={(e) => setTeamForm((p) => ({ ...p, agreeElectronic: e.target.checked }))} /> I accept electronic signature
</label>
...
<label>
<input type="checkbox" checked={freeAgentForm.agreeWaiver} onChange={(e) => setFreeAgentForm((p) => ({ ...p, agreeWaiver: e.target.checked }))} /> I agree to the waiver
</label>
<label>
<input type="checkbox" checked={freeAgentForm.agreeElectronic} onChange={(e) => setFreeAgentForm((p) => ({ ...p, agreeElectronic: e.target.checked }))} /> I accept electronic signature
</label>
